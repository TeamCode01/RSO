...
SAFETY_TEST_RESULTS_HEADERS = [
    ...
    'Очки',
    'Дата',
    'Оплата членского взноса на сегодня',
    'Количество оплативших ЧВ в отряде на 30-е сентября'
]
...
REGIONAL_RANKING_HEADERS = [
    ...
    'Дата подачи',
    'Дата проверки экспертом ОШ',
    'Лучшее региональное отделение по итогам года (место)',
    'Лучшее региональное отделение по комиссарской деятельности (место)',
    'Лучшее региональное отделение по итогам года (сумма мест)',
    'Лучшее региональное отделение по комиссарской деятельности (сумма мест)',
    'Р1 очки',
    'Р1 место',
    'Р2 очки',
    'Р2 место',
...
REGIONAL_COMPETITIONS_HEADERS = [
    '№ п/п', 'Наименование отряда', 'Регион трудоустройства', 'Наименование работодателя', 'Наименование трудового проекта',
    '№ п/п', 'Наименование отряда', 'Регион формирования', 'Наименование работодателя', 'Наименование трудового проекта'
]